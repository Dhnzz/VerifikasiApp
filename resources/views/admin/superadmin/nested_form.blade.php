...
<section class="max-w-screen-lg min-h-screen mx-auto flex flex-col items-center py-48 px-4 lg:px-12 gap-4">
  <div class="w-full p-6 bg-white rounded-xl border border-slate-200 shadow-sm flex flex-col">
    <div class="w-full flex flex-col items-center">
      <p class="font-semibold text-lg">Data Periode</p>
    </div>
    <div class="mt-6">
      <form action="" class="grid grid-cols-12 w-full gap-4">
        <div class="col-span-12">
          ...
          <input type="text" name="nama_periode" id="nama_periode" placeholder="Masukan Nama Periode"
        ...
        <div class="col-span-12">
          ...
          <textarea name="deskripsi_periode" id="deskripsi_periode" placeholder="Masukan Deskripsi Periode"
        ...
        <div class="col-span-12 lg:col-span-6">
          ...
          <input type="date" name="tanggal_mulai" id="tanggal_mulai" placeholder="Tanggal Mulai Periode"
            class="block w-full xl:p-4 p-3 text-gray-900 border border-gray-300 rounded-md bg-gray-50 xl:text-sm text-xs" />
        </div>
        <div class="col-span-12 lg:col-span-6">
          ...
          <input type="date" name="tanggal_berakhir" id="tanggal_berakhir" placeholder="Tanggal Berakhir Periode"
            class="block w-full xl:p-4 p-3 text-gray-900 border border-gray-300 rounded-md bg-gray-50 xl:text-sm text-xs" />
        </div>
