  ...
  <div class="grid grid-cols-12 gap-4">
    ...
    <div
      ...
      <div class="flex flex-col gap-y-1">
        ...
        <span class="text-2xl font-semibold ">{{ ($dosenSi == null)?'Kaprodi SI Belum Ditambahkan':$dosenSi['name']}}</span>
      </div>
    ...
    <div
      ...
      <div class="flex flex-col gap-y-1">
        ...
        <span class="text-2xl font-semibold ">{{ ($dosenPti == null)?'Kaprodi PTI Belum Ditambahkan':$dosenPti['name'] }}</span>
      </div>
      <i class="fas fa-users text-2xl"></i>
    </div>
