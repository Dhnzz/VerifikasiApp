                ...
                <tbody>
                    ...
                    @foreach ($users as $value => $user)
                        <tr>
                                ...
                                @switch($user->role)
                                    ...
                                    @case('kaprodi')
                                        @switch($user->Dosen->prodi)
                                            ...
                                            @case('pti')
                                                <span class="text-xs bg-yellow-700 text-white px-2 py-1 rounded-full ml-2">Kaprodi
                                                    PTI</span>
                                            @break
                            ...
                            <td>
                                <x-button_sm class="inline-flex items-center gap-x-2"
                                    ...
                                    <div class="max-w-lg w-full p-6 rounded-xl overflow-hidden bg-white">
                                        <div class="w-full inline-flex items-center justify-between">
                                            ...
                                            <button id="close-modal"
                                                class="px-3 py-1.5 rounded-lg hover:bg-slate-100 text-slate-800"
                                            ...
                                            <form action="{{ route('kajur.kaprodi.select', $user->id) }}" method="post">
                                                ...
                                                <div class="">
                                                    ...
                                                    <select type="text" placeholder="Prodi" name="prodi"
                                                        ...
                                                        <option value="si"
                                                            {{ $user->Dosen->prodi == 'si' ? 'selected' : '' }}>Sistem
                                                            Informasi</option>
                                                        <option value="pti"
                                                            {{ $user->Dosen->prodi == 'pti' ? 'selected' : '' }}>Pendidikan
