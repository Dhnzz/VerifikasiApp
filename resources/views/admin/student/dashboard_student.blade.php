        ...
        <div class="lg:col-span-4 col-span-12  w-full ">
            <div class="p-6 bg-white flex gap-4 items-center rounded-xl shadow-sm border border-slate-200">
                ...
                <div class="flex flex-col ">
                    ...
                    <span class="text-slate-500 text-sm">{{ ucfirst(Auth::user()->role) }}</span>
                </div>
            </div>
            ...
            <div class="grid grid-cols-12 p-10 bg-white rounded-xl border border-slate-200 shadow-sm">
                ...
                <div class="col-span-12 mt-4 flex flex-col gap-y-2">
                    ...
                    <div class="flex flex-col">
                        ...
                        @php
                            ...
                            $tgl_berakhir = \Carbon\Carbon::parse($periode->tgl_berakhir);
                            $sisa_hari = round($tgl_sekarang->diffInDays($tgl_berakhir, false));
                        @endphp
                        <p class="text-sm">{{ \Carbon\Carbon::parse($periode->tgl_mulai)->format('d F Y') }} -
                            {{ \Carbon\Carbon::parse($periode->tgl_berakhir)->format('d F Y') }} <span
                                class="text-slate-500">({{ $sisa_hari }} hari lagi)</span></p>
                    </div>
                </div>
                ...
                <div class="col-span-12 mt-4 flex flex-col gap-y-4">
                    <div class="flex items-center">
                        ...
                        <a href="" class="text-sm font-semibold text-color-primary-500 underline">Surat Keterangan
                            Tidak Mampu</a>
                    </div>
                    <div class="flex items-center">
                        <span
